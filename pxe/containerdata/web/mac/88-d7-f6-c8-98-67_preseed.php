...
d-i preseed/late_command string in-target /bin/sh -c "mkdir -p /home/<?php echo "$username"; ?>/.ssh/"; in-target /bin/sh -c "curl http://<?php echo "$serverip"; ?>/ansible_hosts_add.php?mac=<?php echo "$mac"; ?>";
