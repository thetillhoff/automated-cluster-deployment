...
d-i preseed/late_command string in-target /bin/sh "mkdir -p /home/<?php echo "$username"; ?>/.ssh/"; in-target /bin/sh -c "curl http://<?php echo "$serverip"; ?>:8888/ansible_hosts_add.php";
