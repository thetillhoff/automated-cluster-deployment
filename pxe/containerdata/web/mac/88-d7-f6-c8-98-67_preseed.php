...
d-i netcfg/hostname string <?php echo "$hostname\n"; ?>
...
d-i mirror/http/hostname string <?php echo "$mirror\n"; ?>
...
d-i passwd/user-fullname string <?php echo "$username\n"; ?>
d-i passwd/username string <?php echo "$username\n"; ?>
...
d-i pkgsel/include string <?php echo "$packages\n"; ?>
...
d-i preseed/late_command string mkdir -p /target/home/<?php echo "$username"; ?>/.ssh/; wget <?php echo "$sshurl"; ?> -O /target/home/<?php echo "$username"; ?>/.ssh/authorized_keys; in-target /bin/sh -c "curl http://<?php echo "$serverip"; ?>:8888/ansible_hosts_add.php";
