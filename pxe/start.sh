...
echo -e "initrd \${boot-url}mac/\${mac:hexhyp}.lasthandled && chain \${boot-url}boot_harddrive.php?mac=\${mac:hexhyp} ||" >> /container/tftp/boot.ipxe # if already installed, boot from harddrive
