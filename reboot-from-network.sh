...
ssh -t -i ./key -o "StrictHostKeyChecking=no" -o "UserKnownHostsFile=/dev/null" "$user@$host" 'sudo efibootmgr -A -b $(efibootmgr | grep "^Boot....\* debian$" | cut -c5-8) && sudo systemctl reboot'
